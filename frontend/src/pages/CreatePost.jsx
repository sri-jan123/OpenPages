...
function CreatePost() {
  ...
  const addCategory = () => {
    ...
    if (!exists) setCats((prev) => [...prev, trimmed]);
  ...
  const handleCreatePost = async (e) => {
    ...
    try {
      ...
      if (cat.trim()) {
        ...
        if (!exists) updatedCats.push(cat.trim());
      }
  ...
  if (loading) {
    return <p className="px-6 md:px-[200px] mt-8">Loading...</p>;
  }
  ...
  return (
    <div className="px-6 md:px-[200px] mt-8">
      ...
      <form onSubmit={handleCreatePost} className="flex flex-col space-y-8 mt-4">
